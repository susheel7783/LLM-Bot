# Import necessary modules and setup for FastAPI, LangGraph, and LangChai
...
groq_api_key = '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'  # Groq API key
os.environ["TAVILY_API_KEY"] = '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'  # Set Tavily API key
